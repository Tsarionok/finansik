...
public class CreateCategoryUseCase(ICreateCategoryStorage createCategoryStorage) : ICreateCategoryUseCase
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await createCategoryStorage.CreateCategory(name, groupId, icon, cancellationToken);
    }
}